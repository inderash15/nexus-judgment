...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CBYS-TWm.mjs");
...
//#endregion
export { getCookies as a, setCookie$1 as c, createServerEntry, server_default as default, getCookie as i, defaultStreamHandler as l, HEADERS as n, getResponse as o, deleteCookie$1 as r, requestHandler as s, createStartHandler as t, StartServer as u };
